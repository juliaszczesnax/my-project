# Nomad Talks — Message Templates

> Copy-paste ready. Replace all `[PLACEHOLDERS]` before sending.
> Tone: warm, real, creator energy — never corporate.

---

## Template A — First Outreach DM
**Use on:** Instagram DM or LinkedIn message
**Goal:** Introduce Nomad Talks, personalise the reason you're reaching out, soft CTA to a quick chat
...
## Template B — After They Say Yes
**Use on:** Reply to their "yes" message
**Goal:** Keep the energy up, explain the 15-min pre-chat, send Calendly Event 1 link
...
## Template C — After the Pre-Chat (Both Say Yes)
**Use on:** Follow-up message after the 15-min pre-chat
**Goal:** Confirm the recording, send prep instructions, book via Calendly Event 2
...
Can't wait. Let's make something real. 🌍
